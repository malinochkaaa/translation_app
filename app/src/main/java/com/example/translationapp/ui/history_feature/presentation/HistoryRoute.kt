...
fun HistoryRoute(
    ...
    val viewState by viewModel.translationDetailsData.collectAsStateWithLifecycle(
        initialValue = null,
        lifecycle = lifecycle,
    )
    val action by viewModel.translationListViewAction.collectAsStateWithLifecycle(initialValue = null)
    ...
    TranslationsListScreen(
        emptyListText = context.getString(R.string.history_fragment_empty_list_text),
        items = viewState,
